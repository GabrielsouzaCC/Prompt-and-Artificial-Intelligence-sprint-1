...
| :---: | :--- | :--- | :--- |
| **01** | Tarifação | "Como cobro 25% a mais na recarga no horário de pico das 17h às 20h?" | "Para aplicar uma tarifa dinâmica com acréscimo de 25% no horário de pico (17h às 20h) nos seus eletropostos GoodWe, você deve configurar uma regra de **Tarifação por Tempo de Uso (TOU - Time-of-Use)**.
Essa configuração é realizada diretamente na sua Plataforma de Gestão (CMS/OCPP), que processa os dados de consumo enviados pelo carregador." |
...
| **05** | Escopo | "Me indica um restaurante bom perto da FIAP para eu almoçar?" | "Como o ChargeGrid AI, meu foco é garantir a operação e a eficiência dos seus eletropostos, mas como uma pausa para o almoço é essencial para o operador, aqui estão excelentes opções próximas aos dois principais campi da FIAP em São Paulo." |
