...
class ChargeGridBot:
    def __init__(self, api_key: str):
        # Inicializa o modelo Gemini 1.5 Flash usando a chave de API fornecida
    ...
    def chat(self, user_message: str, history: List[dict] = None) -> Tuple[str, List[dict]]:
        ...
        # 1. Reconstrói o histórico transformando os dicionários em objetos do LangChain
        ...
        # 2. Adiciona a nova mensagem atual do usuário ao fluxo de execução
        langchain_messages.append(HumanMessage(content=user_message))
        
        try:
            # 3. Chama o modelo da Google
        ...
        # 4. Atualiza o histórico no formato de dicionário compatível com o st.session_state
